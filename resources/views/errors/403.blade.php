...
<head>
    ...
    <title>Akses Ditolak - Bimbel Gracia</title>
    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
            ...
            <div class="bg-gray-50 rounded-xl p-4 mb-6 text-left text-sm text-gray-600">
                <p>Anda tidak memiliki izin untuk mengakses halaman ini. Jika menurut Anda ini salah, silakan hubungi Technical Support.</p>
            </div>

            {{-- WhatsApp Button --}}
            <a href="https://wa.me/6285706512155?text={{ urlencode("Masalah : Error 403 - Akses Ditolak\nDeskripsi: (jelaskan halaman/form apa yang Anda buka, tombol apa yang Anda klik)") }}"
               target="_blank"
