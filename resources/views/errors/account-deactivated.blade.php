...
<head>
    ...
    <title>Akun Dinonaktifkan - Bimbel Gracia</title>
    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
            ...
            <p class="text-gray-600 mb-6">
                Akun ini sudah dinonaktifkan.<br>Hubungi admin untuk mengaktifkan kembali akun.
            </p>

            {{-- User info --}}
            <div class="bg-gray-50 rounded-xl p-4 mb-6 text-left">
                <p class="text-xs text-gray-500 uppercase tracking-wide mb-1">Akun</p>
                <p class="text-sm font-medium text-gray-800">{{ $userName }}</p>
            </div>

            {{-- WhatsApp Button --}}
            @if ($adminPhone)
                <a href="https://wa.me/{{ Str::remove('+', $adminPhone) }}?text={{ urlencode($message) }}"
                   target="_blank"
            ...
            @else
                <p class="text-sm text-gray-400">
                    Nomor admin tidak ditemukan.<br>Silakan hubungi admin melalui渠道 lain.
                </p>
            @endif
        </div>
