            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.students.store') }}" class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nickname" value="{{ old('nickname') }}" class="mt-1 w-full border-gray-300 rounded-md" placeholder="Nickname murid" required />
                    ...
                    <div>
                        ...
                        <input type="text" name="full_name" value="{{ old('full_name') }}" class="mt-1 w-full border-gray-300 rounded-md" placeholder="Nama lengkap murid" />
                    ...
                    <div>
                        ...
                        <input type="text" name="parent_name" value="{{ old('parent_name') }}" class="mt-1 w-full border-gray-300 rounded-md" placeholder="Kosongkan jika nomor baru" />
