                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
                        ...
                        <form method="GET" class="flex items-end gap-3">
                            ...
                            <button type="submit" formaction="{{ route('admin.export.class.excel') }}" class="px-4 py-2 rounded-xl bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700 transition-colors">Excel</button>
                            <button type="submit" formaction="{{ route('admin.export.class.pdf') }}" class="px-4 py-2 rounded-xl bg-rose-600 text-white text-sm font-medium hover:bg-rose-700 transition-colors">PDF</button>
                        </form>
                    </div>
                </div>
            </div>
