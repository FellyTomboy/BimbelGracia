<x-app-layout>
    ...
    <div class="py-12"
         x-data="EnrollmentForm({
             formUrl: '{{ route('admin.enrollments.store') }}',
             enrollmentId: null,
             initialType: '{{ $defaultType ?? 'privat' }}',
                ...
                <form id="enrollment-form" class="p-6 space-y-4" @submit.prevent="submit">
                    ...
                    <div class="grid md:grid-cols-2 gap-4" id="rate-fields">
                        <div>
                            ...
                            <input type="number" name="parent_rate" id="parent-rate" value="{{ old('parent_rate') }}" step="1000" class="mt-1 w-full border-gray-300 rounded-md"
                                   @input="markTouched" />
                        ...
                        <div id="teacher-rate-field">
                            ...
                            <input type="number" name="teacher_rate" id="teacher-rate" value="{{ old('teacher_rate') }}" step="1000" class="mt-1 w-full border-gray-300 rounded-md"
                                   @input="markTouched" />
