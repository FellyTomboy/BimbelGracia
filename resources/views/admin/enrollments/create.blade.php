                ...
                <form method="POST" action="{{ route('admin.enrollments.store') }}" class="p-6 space-y-4">
                                    ...
                                    <table class="w-full text-sm">
                                        <template x-for="i in parseInt(count)" :key="i">
                                            <tr>
                                                ...
                                                <td class="py-1">
                                                    <input type="number" name="pricing_tiers_parent[i]" x-bind:name="'pricing_tiers_parent[' + i + ']'" min="0" step="1000" class="w-full border-gray-300 rounded-md text-sm" x-bind:placeholder="'Rp ' + (i * 100000)" />
                                                </td>
                                            </tr>
                                        </template>
                                    </table>
                                    ...
                                    <table class="w-full text-sm">
                                        <template x-for="i in parseInt(count)" :key="i">
                                            <tr>
                                                <td class="py-1 pr-2 text-gray-600 whitespace-nowrap" x-text="i + ' murid:'"></td>
                                                <td class="py-1">
                                                    <input type="number" name="pricing_tiers_teacher[i]" x-bind:name="'pricing_tiers_teacher[' + i + ']'" min="0" step="1000" class="w-full border-gray-300 rounded-md text-sm" x-bind:placeholder="'Rp ' + (i * 50000)" />
                                                </td>
                                            </tr>
                                        </template>
                                    </table>
                    ...
                    <div class="grid md:grid-cols-2 gap-4" id="rate-fields">
                        <div>
                            ...
                            <input type="number" name="parent_rate" id="parent-rate" value="{{ old('parent_rate') }}" step="1000" class="mt-1 w-full border-gray-300 rounded-md" required />
                    ...
                    <div id="agreed-sessions-field">
                        ...
                        <div id="sessions-privat">
                            <select name="agreed_sessions_per_month" id="agreed-sessions-select" class="mt-1 w-full sm:w-48 border-gray-300 rounded-md" required>
                                <option value="4" @selected(old('agreed_sessions_per_month', 4) == 4)>1x seminggu (4x sebulan)</option>
                                <option value="8" @selected(old('agreed_sessions_per_month', 4) == 8)>2x seminggu (8x sebulan)</option>
                                <option value="12" @selected(old('agreed_sessions_per_month', 4) == 12)>3x seminggu (12x sebulan)</option>
                                <option value="16" @selected(old('agreed_sessions_per_month', 4) == 16)>4x seminggu (16x sebulan)</option>
                                <option value="20" @selected(old('agreed_sessions_per_month', 4) == 20)>5x seminggu (20x sebulan)</option>
                                <option value="24" @selected(old('agreed_sessions_per_month', 4) == 24)>6x seminggu (24x sebulan)</option>
                            </select>
                        ...
                        <div id="sessions-kelas" class="hidden">
                            <select name="agreed_sessions_per_month" id="agreed-sessions-select-kelas" class="mt-1 w-full sm:w-48 border-gray-300 rounded-md">
                                ...
                                <option value="4" @selected(old('agreed_sessions_per_month', 16) == 4)>1x seminggu (4x sebulan)</option>
                                ...
                                <option value="20" @selected(old('agreed_sessions_per_month', 16) == 20)>5x seminggu (20x sebulan)</option>
                                <option value="24" @selected(old('agreed_sessions_per_month', 16) == 24)>6x seminggu (24x sebulan)</option>
                            </select>
