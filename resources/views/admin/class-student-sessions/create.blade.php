                ...
                <form method="POST" action="{{ route('admin.class-student-sessions.store') }}" class="p-6 space-y-4">
                    ...
                    <div class="grid md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="session_date" id="session_date" value="{{ old('session_date') }}" class="mt-1 w-full border-gray-300 rounded-md" required />
                    ...
                    <div>
                        ...
                        @php
                            $oldIds = collect((array) old('class_student_ids'))->map(fn ($v) => (string)$v)->values();
                        @endphp
                        <input
                            type="text"
                            name="student_search"
