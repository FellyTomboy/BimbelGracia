            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.teachers.store') }}" class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="whatsapp" value="{{ old('whatsapp') }}" class="mt-1 w-full border-gray-300 rounded-md" placeholder="081703027942" required />
                    ...
                    <div>
                        ...
                        <input type="number" name="class_rate" value="{{ old('class_rate', 0) }}" min="0" step="5000" class="mt-1 w-full border-gray-300 rounded-md" required />
