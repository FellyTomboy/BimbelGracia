<x-app-layout>
    <x-slot name="title">Pendaftar Guru Baru</x-slot>
    <x-slot name="header">
    ...
    <div x-data="teacherRegistrantModal({
        ...
        <div x-show="modalOpen"
            x-on:tr-submit.window="submitModal()"
            x-on:tr-close.window="close()"
