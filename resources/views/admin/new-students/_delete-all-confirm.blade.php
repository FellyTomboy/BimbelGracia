<form id="ns-modal-form" @submit.prevent="$dispatch('ns-submit')">
    ...
    <div class="space-y-4">
        <div class="bg-rose-50 border border-rose-200 rounded-xl p-6 text-center">
            ...
            <p class="text-lg font-semibold text-rose-900 mb-1">Hapus Semua Pendaftar?</p>
            <p class="text-sm text-rose-700">
                <strong>{{ $count }}</strong> data pendaftar akan dihapus permanen.
            </p>
        </div>

        <div class="bg-amber-50 border border-amber-200 rounded-lg p-3">
            <p class="text-sm text-amber-700">
                <strong>Perhatian:</strong> Tindakan ini tidak bisa dibatalkan. Semua data pendaftar akan dihapus dari database.
            </p>
        </div>
    </div>
