...
<script>
    ...
    window.__bulkForceUrls.lessonOffers = '{{ route('admin.lesson-offers.bulk-force-destroy') }}';
</script>
@endpush
...
<x-app-layout>
    ...
    <div class="py-12"
         x-data="fdOnlyInactiveModal('lesson-offers', 'tawaran les', 'Tawaran Les', 'fd-modal-lesson-offers')"
