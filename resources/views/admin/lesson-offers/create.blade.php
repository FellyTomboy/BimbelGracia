<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Tawaran Les</h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.lesson-offers.store') }}" class="p-6 space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <input name="subject" value="{{ old('subject') }}" class="mt-1 w-full border-gray-300 rounded-md" required />
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="time" name="schedule_time" value="{{ old('schedule_time') }}" class="mt-1 w-full border-gray-300 rounded-md" required />
                    ...
                    <div>
                        ...
                        <input name="contact_whatsapp" value="{{ old('contact_whatsapp') }}" class="mt-1 w-full border-gray-300 rounded-md" />
                    ...
                    <div>
                        ...
                        <textarea name="note" rows="3" class="mt-1 w-full border-gray-300 rounded-md">{{ old('note') }}</textarea>
