<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Murid Kelas Bersama</h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.class-students.store') }}" class="p-6 space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="number" name="rate_per_meeting" value="{{ old('rate_per_meeting', 0) }}" min="0" step="5000" class="mt-1 w-full border-gray-300 rounded-md" required />
