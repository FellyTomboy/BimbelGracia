<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Presensi</h2>
            <a href="{{ route('admin.presensi.index') }}"
               class="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-200 text-gray-600 text-sm font-medium hover:bg-gray-50 transition-colors">
                ← Kembali
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-8"
        x-data="{
            ...
            billingModeMonthly: {{ $billingMode === 'monthly' ? 'true' : 'false' }},
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('admin.presensi.store-bulk') }}"
                        ...
                        <template x-for="(session, sessionIndex) in sessions" :key="session.id">
                            <div x-show="activeTab === sessionIndex"
                                ...
                                <div x-show="selectedProgramType !== 'kelas'" class="mb-4">
                                    ...
                                    <p x-show="availableStudents.length === 0" class="text-xs text-gray-400 italic">Pilih enrollment terlebih dahulu.</p>
                                </div>
