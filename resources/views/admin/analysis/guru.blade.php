            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="flex">
                    ...
                    <div class="w-1/3 border-r border-gray-100">
                        <div class="p-4 font-bold text-gray-700">Daftar Guru</div>
                    ...
                    <div class="w-2/3 p-6">
                            ...
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <div class="flex items-center gap-2">
                                    @if ($selected['teacher']?->whatsapp_number)
                                        <a href="https://wa.me/{{ $selected['teacher']->whatsapp_number }}?text={{ urlencode($selected['message']) }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700 transition-colors">
                            ...
                            <div class="overflow-x-auto border rounded-lg mb-6">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Murid / Program</th>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach ($selected['lines'] as $line)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">Rp {{ number_format($line['total'] - ($line['penalty'] ?? 0)) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                        ...
                        @else
                            <div class="flex items-center justify-center h-full">
                                <p class="text-gray-500">Pilih guru dari daftar di samping untuk melihat detail.</p>
                            </div>
                        @endif
                    </div>
                </div>
