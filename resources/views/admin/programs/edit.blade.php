                ...
                <form method="POST" action="{{ route('admin.programs.update', $program) }}" class="p-6 space-y-4">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="default_parent_rate" value="{{ old('default_parent_rate', $program->default_parent_rate) }}" class="mt-1 w-full border-gray-300 rounded-md" required />
                        ...
                        <div>
                            ...
                            <input type="number" name="default_teacher_rate" value="{{ old('default_teacher_rate', $program->default_teacher_rate) }}" class="mt-1 w-full border-gray-300 rounded-md" required />
