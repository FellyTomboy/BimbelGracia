                    ...
                    <div id="section-privat-price" class="hidden">
                        <div class="grid md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="default_parent_rate" value="{{ old('default_parent_rate', $program->default_parent_rate) }}" min="1" step="5000" class="mt-1 w-full border-gray-300 rounded-md" />
                            ...
                            <div>
                                ...
                                <input type="number" name="default_teacher_rate" value="{{ old('default_teacher_rate', $program->default_teacher_rate) }}" min="1" step="5000" class="mt-1 w-full border-gray-300 rounded-md" />
