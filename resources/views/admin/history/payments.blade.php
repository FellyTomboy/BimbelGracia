                    ...
                    <table class="min-w-full text-sm">
                        ...
                        <tbody class="divide-y">
                            @foreach ($attendances as $attendance)
                                @php
                                    $rateParent = $attendance->lesson?->parent_rate ?? 0;
                                    $rateTeacher = $attendance->lesson?->teacher_rate ?? 0;
                                    $totalParent = $attendance->total_lessons * $rateParent;
                                    $totalTeacher = $attendance->total_lessons * $rateTeacher;
                                @endphp
                                <tr>
