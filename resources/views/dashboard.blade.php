        ...
        @if ($role === 'admin')
            ...
            <div id="modal-laporan" class="fixed inset-0 z-50 hidden bg-black/40 flex items-center justify-center p-4" onclick="closeModalOutside(event, 'modal-laporan')">
                <div class="bg-white rounded-2xl shadow-xl max-w-sm w-full p-6 space-y-1 animate-fade-in">
                    ...
                    <a href="{{ route('admin.class-reports.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-50 text-gray-700 font-medium transition-colors"><img src="{{ asset('storage/icons/icon-laporan-kelas.png') }}" alt="" class="w-5 h-5 object-contain shrink-0">Riwayat Kelas</a>
                    <a href="{{ route('admin.history.students') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-50 text-gray-700 font-medium transition-colors"><img src="{{ asset('storage/icons/icon-murid.png') }}" alt="" class="w-5 h-5 object-contain shrink-0">Riwayat Murid</a>
                    <a href="{{ route('admin.history.teachers') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-50 text-gray-700 font-medium transition-colors"><img src="{{ asset('storage/icons/icon-guru.png') }}" alt="" class="w-5 h-5 object-contain shrink-0">Riwayat Guru</a>
