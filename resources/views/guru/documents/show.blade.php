                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3 mt-4">
                                <button type="button" onclick="window.open('{{ route('guru.documents.viewer', $document) }}', '_blank', 'width=1200,height=800,menubar=no,toolbar=no,location=no,status=no')" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700 transition-colors cursor-pointer">
