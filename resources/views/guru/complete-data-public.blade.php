<x-guest-layout>
    ...
    <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-6">Lengkapi Data Guru Sebelum Slip Gaji</h2>
    ...
    <form method="POST" action="{{ route('complete-data.guru.submit', $teacher->id) }}" class="space-y-6">
        @csrf
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="full_name" value="{{ old('full_name', $teacher->full_name) }}" class="mt-1 w-full border-gray-300 rounded-md" required placeholder="Nama lengkap" />
