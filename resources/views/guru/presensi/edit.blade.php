    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
                <form method="POST" action="{{ route('guru.presensi.update', $attendance) }}" class="p-6 space-y-5" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="date" name="lesson_date" value="{{ old('lesson_date', $attendance->lesson_date?->format('Y-m-d')) }}" class="mt-1 w-full rounded-xl border-gray-200 text-sm" required max="{{ date('Y-m-d') }}" />
                    ...
                    <div>
                        ...
                        @endif
                        <input type="file" name="image" accept="image/jpeg,image/png,image/jpg,image/gif,webp" class="mt-1 w-full rounded-xl border-gray-200 text-sm file:mr-3 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-indigo-50 file:text-indigo-600 hover:file:bg-indigo-100" />
