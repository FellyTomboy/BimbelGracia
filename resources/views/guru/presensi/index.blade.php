                                    ...
                                    <td class="py-3 px-4">
                                        @if ($attendance->status_validation !== 'ditolak')
                                            <div class="flex items-center gap-2">
                                                <a href="{{ route('guru.presensi.edit', $attendance) }}" class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium text-indigo-600 bg-indigo-50 hover:bg-indigo-100 transition-colors">
                                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                                    Edit
                                                </a>
                                                <form action="{{ route('guru.presensi.destroy', $attendance) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus presensi ini?');">
                                                    @csrf
                                                    @method('DELETE')
