    ...
    <div class="py-6 sm:py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                <form method="GET" action="{{ route('parent.history.index') }}" class="flex flex-col sm:flex-row items-start sm:items-end gap-4">
                    <div>
                                        ...
                                        <td class="py-3 px-3 sm:px-4">
                                            ...
                                            @elseif ($attendance->parent_review_status === 'pending')
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    <form method="POST" action="{{ route('parent.history.cancel-reject', $attendance) }}" onsubmit="return confirm('Batalkan penolakan presensi ini?')">
                                                        @csrf
