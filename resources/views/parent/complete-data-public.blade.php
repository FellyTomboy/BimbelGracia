<x-guest-layout>
    ...
    <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-6">Lengkapi Data Sebelum Melihat Invoice</h2>
    ...
    <form method="POST" action="{{ route('complete-data.parent.submit', $parent->id) }}" class="space-y-6">
        @csrf
